...
model = load_model('mask_resnet50.h5') # ⚠️ SESUAIKAN ⚠️

def model_predict(img, model):
    img = img.resize((150, 150))            # ⚠️ SESUAIKAN ⚠️
...
def predict():
    if request.method == 'POST':
        ...
        target_names = ['mask', 'no_mask']     # ⚠️ SESUAIKAN ⚠️
